...
use App\Http\Validators\NewsCategoryValidator;
...
class NewsCategoryController extends Controller
{
    ...
    protected $newsCategoryValidator;

    /**
     * @param NewsCategoryValidator $newsCategoryValidator
     */
    public function __construct(NewsCategoryValidator $newsCategoryValidator)
    {
        $this->newsCategoryValidator = $newsCategoryValidator;
    }
    ...
    public function index(Request $request): array
    {
        try {
            ...
            $validator = $this->newsCategoryValidator->validateGetAllNewsCategories($dataInput);
            if ($validator->fails()) {
            ...
            $result = DB::table('news_category as ba')
                ->select($columns)
